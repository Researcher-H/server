...
1. [(qiita) Node.jsとExpressでローカルサーバーを構築する(1) ―Node.jsとnpmの導入―](https://qiita.com/koedamon/items/37ea8e9175cf0fd62371)　【読んだ】★★★★ Node x Express でローカルサーバを構築出来るようになった！　あと streaming やその他の色んな技術も情報も盛り沢山！
